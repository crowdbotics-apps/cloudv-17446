"""cloudv_17446 URL Configuration
...
admin.site.site_header = "cloudv"
admin.site.site_title = "cloudv Admin Portal"
admin.site.index_title = "cloudv Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="cloudv API",
        default_version="v1",
        description="API documentation for cloudv App",
    ),
    public=True,
